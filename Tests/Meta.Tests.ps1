# ---------------------------------------------------------------
# Meta Related Pester Tests
# ---------------------------------------------------------------

<#
    .DESCRIPTION
        This file contains Pester tests for the various "Meta" tests.
    .LINK
        https://github.com/psake/PowerShellBuild/blob/pesterv5/tests/Meta.tests.ps1
    .NOTES
...
Describe 'Text files formatting' {
    ...
    BeforeAll {
        ...
        $global:allTextFiles = Get-TextFilesList $projectRoot
    }
